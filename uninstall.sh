...
# Uninstall Script - AutoscriptXRAY (Fixed Version)
...
# Hentikan semua service wireguard jika ada
systemctl stop wg-quick@* >/dev/null 2>&1 || true
systemctl disable wg-quick@* >/dev/null 2>&1 || true
...
echo ""
echo -e "${YELLOW}💡 Sangat disarankan untuk melakukan restart VPS:${NC} reboot"
echo ""
